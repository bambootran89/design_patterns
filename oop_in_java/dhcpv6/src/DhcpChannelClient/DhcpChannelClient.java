...
/** DHCPv6 channel client implementation. */
public class DhcpChannelClient implements Runnable {
  private DhcpChannel dhcpChannel;

  public DhcpChannelClient() throws IOException, SocketException {
  ...
  private void sendInfoRequest(int id, DhcpMessage msg) {
    ...
    DhcpUserClassOption dhcpUserClassOption = new DhcpUserClassOption(userClassOption);
