 ...
 * <p>
 * Stores menu items in an ArrayList and provides an iterator for them.
 * <p>
 * <b>Pattern Role:</b> Concrete Aggregate.
 * <p>
 * Uses ArrayList to store MenuItem objects, contrasting with DinerMenu's array.
 * Despite different internal structures, both implement the same Menu interface
 * and return iterators, demonstrating the Iterator pattern's power to hide
